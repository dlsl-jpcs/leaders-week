        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-80 rounded-3xl overflow-hidden shadow-xl">
              <Image src="/placeholder.svg?height=600&width=800" alt="Leaders Week" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-green-800 text-white py-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-green-100">Email: csao@dlsl.edu.ph</p>
        ...
        <div className="max-w-7xl mx-auto mt-8 pt-8 border-t border-green-700 text-center text-green-200">
          <p>© 2025 De La Salle Lipa. All rights reserved.</p>
        </div>
      </footer>
    </main>
  )
